...
//IO方向设置
#define FDC_SDA_IN()  {GPIOA->CRL&=0X0FFFFFFF;GPIOA->CRL|=(u32)8<<4*7;}
#define FDC_SDA_OUT() {GPIOA->CRL&=0X0FFFFFFF;GPIOA->CRL|=(u32)3<<4*7;}

//IO操作函数	 
#define FDC_IIC_SCL    PAout(6) 	//SCL
#define FDC_IIC_SDA    PAout(7)   //输出SDA	 
#define FDC_READ_SDA   PAin(7) 		//输入SDA  
#define FDC_SELECT 			PAout(1)
